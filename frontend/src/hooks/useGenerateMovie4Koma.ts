...
const ERROR_MESSAGES: Record<ErrorCode, string> = {
    ...
    DEMO_LIMIT_EXCEEDED: '本日のデモ回数に達しました。プランをアップグレードするか、BYOKモードでお試しください。',
    DEMO_UNAVAILABLE: '現在デモを一時停止しています。BYOKモードでAPIキーを入力してお試しください。',
    USAGE_LIMIT_EXCEEDED: '今月の利用回数に達しました。プランをアップグレードするか、BYOKモードでお試しください。',
    AUTH_REQUIRED: 'この機能を利用するにはログインまたはプランのアップグレードが必要です。',
