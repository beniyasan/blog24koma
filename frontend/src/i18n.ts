...
export const MESSAGES: Record<Language, Record<string, string>> = {
    ja: {
        ...
        'title.custom': '自作4コマメーカー',
        'custom.hero.title': '自作4コマメーカー',
        'custom.hero.subtitle': '自由なテキストから絵コンテを作成し、編集して4コマ漫画を生成',
        'custom.step.input': '入力',
        'custom.step.edit': '編集',
        'custom.step.result': '結果',
        'custom.input.title': 'テキストを入力',
        'custom.input.subtitle': '4コマ漫画にしたい内容を自由に入力してください',
        'custom.input.text': '4コマにする内容',
        'custom.input.text.placeholder': '例: 朝起きて会社に行くまでの一日。まず目覚ましが鳴るが二度寝してしまい、慌てて準備を始める。なんとか電車に間に合ったが、会社に着いたら今日は休日だったというオチ。',
        'custom.input.generate': '絵コンテを生成',
        'custom.storyboard.title': '絵コンテを編集',
        'custom.storyboard.subtitle': '生成された絵コンテを確認・編集してください',
        'custom.storyboard.scene': 'シーン',
        'custom.storyboard.scene.placeholder': '描画される場面の説明',
        'custom.storyboard.speaker': '話者',
        'custom.storyboard.speaker.placeholder': '話者（任意）',
        'custom.storyboard.dialogue': 'セリフ',
        'custom.storyboard.dialogue.placeholder': 'キャラクターのセリフ',
        'custom.storyboard.dialogue.add': 'セリフを追加',
        'custom.storyboard.dialogue.remove': 'セリフを削除',
        'custom.characters.title': '登場人物',
        'custom.characters.subtitle': 'キャラクター設定（任意。画像生成に反映されます）',
        'custom.characters.empty': '登場人物は未設定です（必要なら追加してください）',
        'custom.characters.add': '登場人物を追加',
        'custom.characters.name': '名前',
        'custom.characters.name.placeholder': '名前（例: アリス）',
        'custom.characters.description': '特徴',
        'custom.characters.description.placeholder': '例: 20代の女性エンジニア。黒髪ボブ。明るい性格。',
        'custom.characters.remove': '削除',
        'custom.edit.back': '最初からやり直す',
        'custom.edit.generate': '4コマを生成',
        'custom.result.title': '生成結果',
        'custom.result.backToEdit': '絵コンテを編集',
        'custom.result.newCreate': '新しく作る',
        'custom.loading.storyboard': '絵コンテを生成中...',
        'custom.loading.image': '4コマ画像を生成中...',
        ...
        'intro.hero.title': '機能紹介',
        'intro.hero.subtitle': 'ブログ記事やYouTube動画のURLを貼るだけで、AIが4コマ漫画を自動生成します。',
        'intro.hero.note': 'デモ（透かしあり）/ BYOK（APIキーは保存しません）に対応',

        'intro.notice.title': '1分でわかる',
        'intro.notice.item1': 'URLを貼るだけで4コマ漫画を自動生成',
        'intro.notice.item2': 'ブログ（Note/Qiita/Zenn）とYouTube動画に対応',
        'intro.notice.item3': 'デモで試す / BYOKで透かしなし（APIキーは保存しません）',

        'intro.section.features.title': 'できること',
        'intro.features.blog.title': 'ブログ4コマ',
        'intro.features.blog.desc': '記事URLから内容を要約し、起承転結の4コマ漫画に変換します。',
        'intro.features.movie.title': '動画4コマ',
        'intro.features.movie.desc': 'YouTube動画の内容を解析して、4コマ漫画に変換します。',
        'intro.features.howto.title': '使い方ガイド',
        'intro.features.howto.desc': '操作の流れや注意点を画像つきで確認できます。',

        'intro.section.sample.title': 'サンプル（デモ出力）',
        'intro.sample.alt': '生成サンプルの4コマ漫画',
        'intro.sample.caption': '長い技術記事でも、要点が4コマでサクッと把握できます。',
        'intro.sample.point1': '要点を起承転結のストーリーに変換',
        'intro.sample.point2': 'セリフ付きで内容が頭に入りやすい',

        'intro.section.steps.title': '使い方（3ステップ）',
        'intro.steps.step1.title': 'URLを入力',
        'intro.steps.step1.desc': 'ブログ記事URL、またはYouTube動画URLを貼り付けます。',
        'intro.steps.step2.title': '生成を開始',
        'intro.steps.step2.desc': '内容を解析して、絵コンテ→画像の順に4コマを作ります。',
        'intro.steps.step3.title': '結果を確認',
        'intro.steps.step3.desc': '4コマ画像を保存し、必要なら絵コンテも表示できます。',

        'intro.section.modes.title': 'モード',
        'intro.modes.demo.title': 'デモ',
        'intro.modes.demo.desc': '今すぐ試せます（回数制限・透かしあり）。',
        'intro.modes.byok.title': 'BYOK',
        'intro.modes.byok.desc': 'あなたのGemini APIキーで実行します（キーは保存しません）。',
        'intro.section.next.title': '次にやること',
        'intro.cta.blog': 'ブログ4コマへ',
        'intro.cta.movie': '動画4コマへ',
        'intro.cta.pricing': '料金プランを見る',
    },
    en: {
        ...
        'title.custom': 'Custom 4-Koma Maker',
        'custom.hero.title': 'Custom 4-Koma Maker',
        'custom.hero.subtitle': 'Create a storyboard from free text, edit it, and generate a 4-panel comic',
        'custom.step.input': 'Input',
        'custom.step.edit': 'Edit',
        'custom.step.result': 'Result',
        'custom.input.title': 'Enter your text',
        'custom.input.subtitle': 'Describe what you want to turn into a 4-panel comic',
        'custom.input.text': 'Content to convert',
        'custom.input.text.placeholder': 'Example: A typical morning rush. The alarm rings but you hit snooze. You rush to get ready and barely catch the train. When you arrive at the office, you realize it\'s a holiday.',
        'custom.input.generate': 'Generate storyboard',
        'custom.storyboard.title': 'Edit storyboard',
        'custom.storyboard.subtitle': 'Review and edit the generated storyboard',
        'custom.storyboard.scene': 'Scene',
        'custom.storyboard.scene.placeholder': 'Description of the scene to draw',
        'custom.storyboard.speaker': 'Speaker',
        'custom.storyboard.speaker.placeholder': 'Speaker (optional)',
        'custom.storyboard.dialogue': 'Dialogue',
        'custom.storyboard.dialogue.placeholder': 'Character dialogue',
        'custom.storyboard.dialogue.add': 'Add dialogue',
        'custom.storyboard.dialogue.remove': 'Remove dialogue',
        'custom.characters.title': 'Characters',
        'custom.characters.subtitle': 'Optional. Used for consistent character depiction in the image.',
        'custom.characters.empty': 'No characters yet. Add if you want.',
        'custom.characters.add': 'Add character',
        'custom.characters.name': 'Name',
        'custom.characters.name.placeholder': 'Name (e.g., Alice)',
        'custom.characters.description': 'Description',
        'custom.characters.description.placeholder': 'e.g., A cheerful developer with short black hair.',
        'custom.characters.remove': 'Remove',
        'custom.edit.back': 'Start over',
        'custom.edit.generate': 'Generate 4-panel comic',
        'custom.result.title': 'Result',
        'custom.result.backToEdit': 'Edit storyboard',
        'custom.result.newCreate': 'Create new',
        'custom.loading.storyboard': 'Generating storyboard...',
        'custom.loading.image': 'Generating 4-panel comic...',
        ...
        'intro.hero.title': 'Introduction',
        'intro.hero.subtitle': 'Paste a blog post or YouTube URL and we generate a 4-panel comic with AI.',
        'intro.hero.note': 'Supports Demo (watermarked) / BYOK (your key, never stored)',

        'intro.notice.title': 'In one minute',
        'intro.notice.item1': 'Paste a URL to generate a 4-panel comic',
        'intro.notice.item2': 'Supports blogs (Note/Qiita/Zenn) and YouTube videos',
        'intro.notice.item3': 'Try Demo or use BYOK for no watermark (API key is never stored)',

        'intro.section.features.title': 'What you can do',
        'intro.features.blog.title': 'Blog 4-Koma',
        'intro.features.blog.desc': 'Turn an article URL into a 4-panel comic with a clear story arc.',
        'intro.features.movie.title': 'Video 4-Koma',
        'intro.features.movie.desc': 'Analyze a YouTube video and turn it into a 4-panel comic.',
        'intro.features.howto.title': 'How-to guide',
        'intro.features.howto.desc': 'See the flow and tips with screenshots.',

        'intro.section.sample.title': 'Sample (Demo output)',
        'intro.sample.alt': 'Sample generated 4-panel comic',
        'intro.sample.caption': 'Even a long tech article becomes a quick 4-panel overview.',
        'intro.sample.point1': 'Turn key points into a clear story arc',
        'intro.sample.point2': 'Dialogue makes it easy to follow',

        'intro.section.steps.title': 'How it works (3 steps)',
        'intro.steps.step1.title': 'Paste a URL',
        'intro.steps.step1.desc': 'Paste a blog post URL or a YouTube video URL.',
        'intro.steps.step2.title': 'Start generating',
        'intro.steps.step2.desc': 'We analyze the content and generate storyboard → image.',
        'intro.steps.step3.title': 'Review the result',
        'intro.steps.step3.desc': 'Save the comic image, and optionally view storyboard details.',

        'intro.section.modes.title': 'Modes',
        'intro.modes.demo.title': 'Demo',
        'intro.modes.demo.desc': 'Try instantly (limited, watermarked).',
        'intro.modes.byok.title': 'BYOK',
        'intro.modes.byok.desc': 'Run with your Gemini API key (never stored).',
        'intro.section.next.title': 'Next steps',
        'intro.cta.blog': 'Go to Blog 4-Koma',
        'intro.cta.movie': 'Go to Video 4-Koma',
        'intro.cta.pricing': 'View pricing',
    },
};
