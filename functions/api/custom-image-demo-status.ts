// Custom Image Demo status API endpoint
// Returns the remaining demo count for custom image generation
...
export const onRequestGet: PagesFunction<Env> = async (context) => {
    ...
    try {
        ...
        console.error('Custom image demo status error:', error instanceof Error ? error.message : 'Unknown error');
        return jsonResponse({
            remainingCount: 0,
            maxCount: 3,
            isAvailable: false,
